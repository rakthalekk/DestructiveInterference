...
var tutorial_dialogue: Array = [
	...
	[19.0, "Once they hit zero, they're *Grey Noise*, which you have to dodge!", true],
	...
	[38.0, "Are you ready to deal TWO RHYTHMS?!", false],
	[42.0, "Sometimes there may be multiple beats. Pick a good lain and neutralize!", true],
